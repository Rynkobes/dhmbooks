...
import OutMutation from './queries/OutMutation';

class WarehouseOutbound extends Component {
	constructor(props) {
		super(props);
		this.state = {
			product: [
...
export default graphql(warehouseIn)(graphql(OutMutation)(WarehouseOutbound));
